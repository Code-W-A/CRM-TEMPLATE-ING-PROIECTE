...
export default function LucrariArhivate() {
  ...
  const handleDezarhivare = async (lucrareId: string) => {
    try {
      ...
      toast({
        title: "Succes",
        description: "Proiectul a fost dezarhivat cu succes.",
      })
        ...
        <div className="flex items-center space-x-2">
          ...
          <TooltipProvider>
            <Tooltip>
              ...
              <TooltipContent>Dezarhivează proiectul</TooltipContent>
            </Tooltip>
          </TooltipProvider>
  ...
  if (loading) {
    return (
      <TooltipProvider>
        <DashboardShell>
          <DashboardHeader heading="Proiecte Arhivate" text="Se încarcă proiectele arhivate..." />
  ...
  if (error) {
    return (
      <TooltipProvider>
        <DashboardShell>
          <DashboardHeader heading="Proiecte Arhivate" text="Eroare la încărcarea datelor" />
          <Card>
