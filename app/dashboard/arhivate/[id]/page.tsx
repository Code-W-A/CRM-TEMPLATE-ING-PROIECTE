...
export default function ArchivedWorkDetailPage({ params }: ArchivedWorkDetailPageProps) {
  ...
  useEffect(() => {
    ...
    const fetchData = async () => {
      try {
        ...
        if (lucrareData) {
          // Verificăm că proiectul este efectiv arhivată
          if (lucrareData.statusLucrare !== WORK_STATUS.ARCHIVED) {
            toast({
              title: "Eroare",
              description: "Acest proiect nu este arhivat.",
              variant: "destructive",
            })
          ...
          toast({
            title: "Eroare",
            description: "proiectul nu a fost găsită.",
            variant: "destructive",
          })
          router.push("/dashboard/arhivate")
        }
  ...
  const handleDezarhivare = async () => {
    ...
    try {
      ...
      setTimeout(() => {
        // Redirect către lucrări active unde va apărea proiectul dezarhivată
      ...
      toast({
        title: "Eroare",
        description: "Nu s-a putut dezarhiva proiectul.",
        variant: "destructive",
      })
    } finally {
      setIsUpdating(false)
      ...
      <DashboardShell>
        <div className="flex items-center justify-center h-screen">
          <div className="text-center">
            ...
            <p className="mt-2 text-gray-500">Se încarcă proiectul arhivat...</p>
          </div>
        </div>
      </DashboardShell>
    )
      ...
      <DashboardShell>
        <div className="flex items-center justify-center h-screen">
          <div className="text-center">
            ...
            <h2 className="text-xl font-semibold mb-2">proiectul nu a fost găsit</h2>
            <p className="text-gray-500 mb-4">Nu s-a putut găsi proiectul solicitat.</p>
            <Button onClick={() => router.push("/dashboard/arhivate")}>
              Înapoi la Proiecte Arhivate
            </Button>
          </div>
        </div>
      </DashboardShell>
  ...
  return (
    <TooltipProvider>
      <DashboardShell>
        <DashboardHeader
          heading="Detalii Proiect Arhivat"
          ...
          <div className="flex items-center space-x-2">
            ...
            <TooltipProvider>
              <Tooltip>
                ...
                <TooltipContent>Dezarhivează proiectul și o returnează la statusul Finalizat</TooltipContent>
              </Tooltip>
            </TooltipProvider>
          </div>
        </DashboardHeader>
        ...
        <div className="space-y-6">
          ...
          <Alert className="border-orange-200 bg-orange-50">
            ...
            <AlertDescription className="text-orange-800">
              <strong>Proiectul Arhivat:</strong> Acest proiectu este arhivat și poate fi doar vizualizată. 
          ...
          <Card>
            ...
            <CardContent className="space-y-6">
              <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
                ...
                <div className="space-y-4">
                  <div>
                    <label className="text-sm font-medium text-gray-500">Tip Proiect</label>
            ...
            <Card>
              ...
              <CardContent className="space-y-3">
                {lucrare.lucrareOriginala && (
                  <div>
                    <label className="text-sm font-medium text-gray-500">Proiect Original</label>
