...
export default function Dashboard() {
  ...
  return (
    <DashboardShell>
      <DashboardHeader 
        heading="Dashboard" 
        text="Bine ați venit în sistemul de management al proiectelor"
      />
        ...
        <>
          <div className="grid gap-4 md:grid-cols-2 lg:grid-cols-4">
            <Card className="cursor-pointer" onClick={() => router.push("/dashboard/lucrari")}>
              <CardHeader className="flex flex-row items-center justify-between space-y-0 pb-2">
                <CardTitle className="text-sm font-medium">Proiecte</CardTitle>
          ...
          <Tabs defaultValue="recent" className="mt-6">
                ...
                <CardContent>
                  <div className="space-y-2">
                    ...
                    {getLucrariRecente().length === 0 && (
                      <p className="text-center text-gray-500 py-4">Nu există proiecte recente.</p>
                    )}
                  </div>
                </CardContent>
              </Card>
            ...
            <TabsContent value="pending" className="space-y-4">
              <Card>
                  <CardHeader>
                  <CardTitle>Proiecte În Așteptare</CardTitle>
                  <CardDescription>Proiecte care necesită atenție</CardDescription>
                </CardHeader>
                <CardContent>
                  <div className="space-y-2">
                    ...
                    {getLucrariAsteptare().length === 0 && (
                      <p className="text-center text-gray-500 py-4">Nu există proiecte în așteptare.</p>
                    )}
                  </div>
                </CardContent>
              </Card>
            ...
            <TabsContent value="progress" className="space-y-4">
              <Card>
                  <CardHeader>
                  <CardTitle>Proiecte În Curs</CardTitle>
                  <CardDescription>Proiecte în desfășurare</CardDescription>
                </CardHeader>
                <CardContent>
                  <div className="space-y-2">
                    ...
                    {getLucrariInCurs().length === 0 && (
                      <p className="text-center text-gray-500 py-4">Nu există proiecte în curs.</p>
                    )}
                  </div>
                </CardContent>
              </Card>
